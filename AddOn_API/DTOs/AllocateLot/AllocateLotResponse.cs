...
{
    public class AllocateLotResponse
    {
        ...
        public virtual ICollection<AllocateLotSizeResponse> AllocateLotSizes { get; set; }
        public virtual ICollection<AllocateMcResponse> AllocateMcs { get; set; }
    }
}